...
public class AdherantSQL {
	...
	public String toString() {
		return "Adhérant [idAdherant=" + idAdherant + ", nomAdherant=" + nomAdherant + ", prenomAdherant=" + prenomAdherant + ", ageAdherant=" + ageAdherant + ", emailAdherant=" + emailAdherant + ", adresseAdherant=" + adresseAdherant + "]";
	}
